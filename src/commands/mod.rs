...
//! CLI validation tests are in `tests/cli_validation.rs` using Given-When-Then format.
 ...
 pub use workspace::{
      AddArgs, DoneArgs, FocusArgs, RemoveArgs, SpawnArgs, StatusArgs, SyncArgs,
      WorkspaceArgs, WorkspaceCommand, WorkspaceListArgs, workspace_add_command, workspace_done_command,
