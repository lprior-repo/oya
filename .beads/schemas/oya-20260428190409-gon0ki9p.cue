...
// Validation schema for bead: oya-20260428190409-gon0ki9p
// Title: slice-04: Add no-secret leak regression
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-gon0ki9p.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-gon0ki9p"
  title: "slice-04: Add no-secret leak regression"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Raw provider stack traces and passwords are absent from evidence/output.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test opencode_no_secret_leak runs, then Raw provider stack traces and passwords are absent from evidence/output.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:09Z"
//   }
// }