...
// Validation schema for bead: oya-20260428190410-28dhoimw
// Title: slice-05: Block on repair budget exhaustion
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190410-28dhoimw.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190410-28dhoimw"
  title: "slice-05: Block on repair budget exhaustion"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "RepairBudgetExhausted blocks without another agent invocation.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test repair_budget_exhaustion runs, then RepairBudgetExhausted blocks without another agent invocation.",
