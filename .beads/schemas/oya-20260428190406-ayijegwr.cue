...
// Validation schema for bead: oya-20260428190406-ayijegwr
// Title: slice-01: Doctor checks Moon tasks
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-ayijegwr.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-ayijegwr"
  title: "slice-01: Doctor checks Moon tasks"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Doctor reports fmt/lint/test/build/ci availability with typed failures.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya doctor runs, then Doctor reports fmt/lint/test/build/ci availability with typed failures.",
