...
// Validation schema for bead: oya-20260428190407-0ukky8sw
// Title: slice-02: Harden bead id parsing
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-0ukky8sw.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-0ukky8sw"
  title: "slice-02: Harden bead id parsing"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Invalid bead ids fail before agent or gate execution.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id bad/../id --prompt noop runs, then Invalid bead ids fail before agent or gate execution.",
