...
// Validation schema for bead: oya-20260428190413-rnswezi5
// Title: slice-09: Add mutation testing opt-in gate
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190413-rnswezi5.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190413-rnswezi5"
  title: "slice-09: Add mutation testing opt-in gate"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Mutation gate is runnable and not accidentally part of fast CI.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when moon run :mutants-quick runs, then Mutation gate is runnable and not accidentally part of fast CI.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:13Z"
//   }
// }