...
// Validation schema for bead: oya-20260428190409-vgssd9y3
// Title: slice-05: Add repair budget types
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-vgssd9y3.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-vgssd9y3"
  title: "slice-05: Add repair budget types"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Budgets decrement and reject invalid counts.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test repair_budget runs, then Budgets decrement and reject invalid counts.",
