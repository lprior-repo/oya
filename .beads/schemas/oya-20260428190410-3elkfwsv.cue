...
// Validation schema for bead: oya-20260428190410-3elkfwsv
// Title: slice-06: Enforce exit code contract
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190410-3elkfwsv.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190410-3elkfwsv"
  title: "slice-06: Enforce exit code contract"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Exit codes match final Oya verdict.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo-fix --prompt noop runs, then Exit codes match final Oya verdict.",
