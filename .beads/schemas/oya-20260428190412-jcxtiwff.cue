...
// Validation schema for bead: oya-20260428190412-jcxtiwff
// Title: slice-08: Fetch and update from main
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190412-jcxtiwff.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190412-jcxtiwff"
  title: "slice-08: Fetch and update from main"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "VCS sync failure records VcsSyncFailed.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop runs, then VCS sync failure records VcsSyncFailed.",
