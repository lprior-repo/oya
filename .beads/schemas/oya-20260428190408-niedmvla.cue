...
// Validation schema for bead: oya-20260428190408-niedmvla
// Title: slice-04: Parse OpenCode server env config
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-niedmvla.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-niedmvla"
  title: "slice-04: Parse OpenCode server env config"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Config parsing redacts secret values in debug/error output.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test opencode_server_config runs, then Config parsing redacts secret values in debug/error output.",
