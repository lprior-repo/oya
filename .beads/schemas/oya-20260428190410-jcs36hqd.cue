...
// Validation schema for bead: oya-20260428190410-jcs36hqd
// Title: slice-06: Generate report from evidence only
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190410-jcs36hqd.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190410-jcs36hqd"
  title: "slice-06: Generate report from evidence only"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Report includes prompt, agent result, gates, findings, and verdict.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya report --run-id demo runs, then Report includes prompt, agent result, gates, findings, and verdict.",
