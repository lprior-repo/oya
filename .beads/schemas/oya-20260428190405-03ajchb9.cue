...
// Validation schema for bead: oya-20260428190405-03ajchb9
// Title: slice-00: Replace repo remote detection with Git
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190405-03ajchb9.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190405-03ajchb9"
  title: "slice-00: Replace repo remote detection with Git"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Doctor detects the GitHub repo slug through Git remote data.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya doctor runs, then Doctor detects the GitHub repo slug through Git remote data.",
