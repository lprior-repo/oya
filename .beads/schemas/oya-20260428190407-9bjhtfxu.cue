...
// Validation schema for bead: oya-20260428190407-9bjhtfxu
// Title: slice-02: Persist RunStarted before action
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-9bjhtfxu.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-9bjhtfxu"
  title: "slice-02: Persist RunStarted before action"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "RunStarted exists even when later work blocks.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop runs, then RunStarted exists even when later work blocks.",
