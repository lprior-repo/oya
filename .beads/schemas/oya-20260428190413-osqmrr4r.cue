...
// Validation schema for bead: oya-20260428190413-osqmrr4r
// Title: slice-09: Add release negative E2E matrix
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190413-osqmrr4r.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190413-osqmrr4r"
  title: "slice-09: Add release negative E2E matrix"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Release negatives prove typed blocked/failed outcomes.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test release_negative_e2e runs, then Release negatives prove typed blocked/failed outcomes.",
