...
// Validation schema for bead: oya-20260428190412-xxkfcmm6
// Title: slice-08: Generate branch names
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190412-xxkfcmm6.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190412-xxkfcmm6"
  title: "slice-08: Generate branch names"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Branch names are valid, bounded, and deterministic.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test branch_name runs, then Branch names are valid, bounded, and deterministic.",
