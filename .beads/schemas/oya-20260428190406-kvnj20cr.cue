...
// Validation schema for bead: oya-20260428190406-kvnj20cr
// Title: slice-00: Remove non-Git VCS health checks
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-kvnj20cr.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-kvnj20cr"
  title: "slice-00: Remove non-Git VCS health checks"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Doctor remains useful when only Git, Moon, Restate, Fjall, and OpenCode are present.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya doctor runs, then Doctor remains useful when only Git, Moon, Restate, Fjall, and OpenCode are present.",
