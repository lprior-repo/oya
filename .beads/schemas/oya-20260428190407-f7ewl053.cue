...
// Validation schema for bead: oya-20260428190407-f7ewl053
// Title: slice-02: Implement basic evidence check
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-f7ewl053.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-f7ewl053"
  title: "slice-02: Implement basic evidence check"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Untampered evidence passes and tampered evidence fails.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya evidence check runs, then Untampered evidence passes and tampered evidence fails.",
