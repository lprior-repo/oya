...
// Validation schema for bead: oya-20260428190409-pdrj11by
// Title: slice-05: Re-run failed plus previous gates
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-pdrj11by.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-pdrj11by"
  title: "slice-05: Re-run failed plus previous gates"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Reverification evidence shows the whole required gate set.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya verify --bead-id demo --repair runs, then Reverification evidence shows the whole required gate set.",
