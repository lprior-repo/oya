...
// Validation schema for bead: oya-20260428190411-3tt96ljf
// Title: slice-07: Add read-only lifecycle panel
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-3tt96ljf.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-3tt96ljf"
  title: "slice-07: Add read-only lifecycle panel"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Panel shows selected run status without mutating backend state.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when frontend e2e lifecycle panel runs, then Panel shows selected run status without mutating backend state.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:11Z"
//   }
// }