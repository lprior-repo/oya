...
// Validation schema for bead: oya-20260428190408-6pmuirda
// Title: slice-04: Persist AgentRequest
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-6pmuirda.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-6pmuirda"
  title: "slice-04: Persist AgentRequest"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "AgentRequest exists before agent execution starts.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop runs, then AgentRequest exists before agent execution starts.",
