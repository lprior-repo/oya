...
// Validation schema for bead: oya-20260428190407-m444rygf
// Title: slice-02: Add RunId value type
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-m444rygf.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-m444rygf"
  title: "slice-02: Add RunId value type"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Run IDs serialize, display, and reject malformed values.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test run_id runs, then Run IDs serialize, display, and reject malformed values.",
