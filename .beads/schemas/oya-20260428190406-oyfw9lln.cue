...
// Validation schema for bead: oya-20260428190406-oyfw9lln
// Title: slice-00: Replace workspace cleanup with Git/filesystem cleanup
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-oyfw9lln.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-oyfw9lln"
  title: "slice-00: Replace workspace cleanup with Git/filesystem cleanup"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Cleanup no longer shells to a non-Git VCS command.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test compensation runs, then Cleanup no longer shells to a non-Git VCS command.",
