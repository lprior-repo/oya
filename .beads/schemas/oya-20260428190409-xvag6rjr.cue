...
// Validation schema for bead: oya-20260428190409-xvag6rjr
// Title: slice-05: Persist RepairRequest
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-xvag6rjr.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-xvag6rjr"
  title: "slice-05: Persist RepairRequest"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "RepairRequest points to finding, gate, scope, and retry count.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya verify --bead-id demo --repair runs, then RepairRequest points to finding, gate, scope, and retry count.",
