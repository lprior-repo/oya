...
// Validation schema for bead: oya-20260428190412-ubddtbl1
// Title: slice-08: Create GitHub PR after green gates
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190412-ubddtbl1.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190412-ubddtbl1"
  title: "slice-08: Create GitHub PR after green gates"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "PR evidence is persisted with URL and branch.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop runs, then PR evidence is persisted with URL and branch.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:12Z"
//   }
// }