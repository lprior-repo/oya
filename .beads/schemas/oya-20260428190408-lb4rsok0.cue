...
// Validation schema for bead: oya-20260428190408-lb4rsok0
// Title: slice-03: Persist gate start and finish
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-lb4rsok0.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-lb4rsok0"
  title: "slice-03: Persist gate start and finish"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Gate evidence exists for success and failure paths.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya verify --bead-id demo --gate fmt runs, then Gate evidence exists for success and failure paths.",
