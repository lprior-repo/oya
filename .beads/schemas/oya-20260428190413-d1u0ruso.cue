...
// Validation schema for bead: oya-20260428190413-d1u0ruso
// Title: slice-09: Document security warning policy
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190413-d1u0ruso.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190413-d1u0ruso"
  title: "slice-09: Document security warning policy"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Known warnings are documented; unexpected failures remain visible.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when moon run :security runs, then Known warnings are documented; unexpected failures remain visible.",
