...
// Validation schema for bead: oya-20260428190412-urcldg2l
// Title: slice-09: Add output limit regression
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190412-urcldg2l.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190412-urcldg2l"
  title: "slice-09: Add output limit regression"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Oversized outputs do not blow memory or evidence size.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test output_limit runs, then Oversized outputs do not blow memory or evidence size.",
