...
// Validation schema for bead: oya-20260428190408-rv9y6md8
// Title: slice-03: Bound gate stdout and stderr
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-rv9y6md8.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-rv9y6md8"
  title: "slice-03: Bound gate stdout and stderr"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Oversized output is bounded and marked.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test bounded_gate_output runs, then Oversized output is bounded and marked.",
