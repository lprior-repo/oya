...
// Validation schema for bead: oya-20260428190409-oxixkuqx
// Title: slice-04: Persist AgentRun result
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-oxixkuqx.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-oxixkuqx"
  title: "slice-04: Persist AgentRun result"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "AgentRun evidence is persisted for failure.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop --model bad/model runs, then AgentRun evidence is persisted for failure.",
