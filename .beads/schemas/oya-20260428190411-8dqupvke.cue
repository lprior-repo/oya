...
// Validation schema for bead: oya-20260428190411-8dqupvke
// Title: slice-07: Fix frontend domain module
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-8dqupvke.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-8dqupvke"
  title: "slice-07: Fix frontend domain module"
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo check --target wasm32-unknown-unknown runs, then Frontend module tree compiles.",
