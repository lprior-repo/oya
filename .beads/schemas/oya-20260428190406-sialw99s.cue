...
// Validation schema for bead: oya-20260428190406-sialw99s
// Title: slice-00: Rewrite active docs to Git-only
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-sialw99s.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-sialw99s"
  title: "slice-00: Rewrite active docs to Git-only"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Active docs describe Git-only flow; archived docs are clearly non-authoritative if retained.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when rg non_git_vcs_active_docs runs, then Active docs describe Git-only flow; archived docs are clearly non-authoritative if retained.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:06Z"
//   }
// }