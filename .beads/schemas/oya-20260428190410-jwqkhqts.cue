...
// Validation schema for bead: oya-20260428190410-jwqkhqts
// Title: slice-06: Add fake-agent E2E harness
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190410-jwqkhqts.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190410-jwqkhqts"
  title: "slice-06: Add fake-agent E2E harness"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Fake-agent E2E proves run evidence and gate behavior.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test full_loop_fake_agent runs, then Fake-agent E2E proves run evidence and gate behavior.",
