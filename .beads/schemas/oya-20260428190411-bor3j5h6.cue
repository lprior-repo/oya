...
// Validation schema for bead: oya-20260428190411-bor3j5h6
// Title: slice-08: Claim Git workspace ownership
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-bor3j5h6.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-bor3j5h6"
  title: "slice-08: Claim Git workspace ownership"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Unowned dirty workspace blocks before agent execution.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop runs, then Unowned dirty workspace blocks before agent execution.",
