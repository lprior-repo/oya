...
// Validation schema for bead: oya-20260428190408-seq4yxht
// Title: slice-04: Prove subprocess invalid-model failure
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-seq4yxht.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-seq4yxht"
  title: "slice-04: Prove subprocess invalid-model failure"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Invalid model returns sanitized typed failure.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop --model bad/model runs, then Invalid model returns sanitized typed failure.",
