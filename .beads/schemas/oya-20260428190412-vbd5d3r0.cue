...
// Validation schema for bead: oya-20260428190412-vbd5d3r0
// Title: slice-09: Enforce one run per bead
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190412-vbd5d3r0.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190412-vbd5d3r0"
  title: "slice-09: Enforce one run per bead"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Second same-bead run returns BeadAlreadyRunning.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test bead_concurrency runs, then Second same-bead run returns BeadAlreadyRunning.",
