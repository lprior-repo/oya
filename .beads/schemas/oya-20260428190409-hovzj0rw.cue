...
// Validation schema for bead: oya-20260428190409-hovzj0rw
// Title: slice-05: Build bounded repair prompt
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-hovzj0rw.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-hovzj0rw"
  title: "slice-05: Build bounded repair prompt"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Prompt excludes raw log spam and includes the next command.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test repair_prompt runs, then Prompt excludes raw log spam and includes the next command.",
