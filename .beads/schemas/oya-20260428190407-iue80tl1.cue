...
// Validation schema for bead: oya-20260428190407-iue80tl1
// Title: slice-02: Add base evidence record envelope
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-iue80tl1.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-iue80tl1"
  title: "slice-02: Add base evidence record envelope"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Evidence envelopes round-trip through canonical JSON.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test evidence_envelope runs, then Evidence envelopes round-trip through canonical JSON.",
