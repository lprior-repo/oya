...
// Validation schema for bead: oya-20260428190408-c3ksipf2
// Title: slice-03: Explain finding by id
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-c3ksipf2.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-c3ksipf2"
  title: "slice-03: Explain finding by id"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Explain prints category, command, bounded output, and next action.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya explain --finding-id demo runs, then Explain prints category, command, bounded output, and next action.",
