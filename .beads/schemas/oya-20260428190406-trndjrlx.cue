...
// Validation schema for bead: oya-20260428190406-trndjrlx
// Title: slice-01: Doctor checks OpenCode configuration
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-trndjrlx.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-trndjrlx"
  title: "slice-01: Doctor checks OpenCode configuration"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Doctor reports OpenCode mode without printing secrets.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya doctor runs, then Doctor reports OpenCode mode without printing secrets.",
