...
// Validation schema for bead: oya-20260428190407-sni6hgrs
// Title: slice-03: Add GateId and gate model
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-sni6hgrs.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-sni6hgrs"
  title: "slice-03: Add GateId and gate model"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Gate ids parse and map to canonical command names.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test gate_id runs, then Gate ids parse and map to canonical command names.",
