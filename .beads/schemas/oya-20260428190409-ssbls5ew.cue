...
// Validation schema for bead: oya-20260428190409-ssbls5ew
// Title: slice-05: Enforce format-only mutation scope
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-ssbls5ew.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-ssbls5ew"
  title: "slice-05: Enforce format-only mutation scope"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Out-of-scope changes block with MutationScopeViolation.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya verify --bead-id demo --repair runs, then Out-of-scope changes block with MutationScopeViolation.",
