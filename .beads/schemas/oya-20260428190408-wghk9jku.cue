...
// Validation schema for bead: oya-20260428190408-wghk9jku
// Title: slice-04: Prove server auth failure is safe
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-wghk9jku.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-wghk9jku"
  title: "slice-04: Prove server auth failure is safe"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Wrong password produces typed sanitized failure.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when OPENCODE_SERVER_PASSWORD=bad oya run --bead-id demo --prompt noop runs, then Wrong password produces typed sanitized failure.",
