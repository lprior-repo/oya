...
// Validation schema for bead: oya-20260428190410-xwo3kz0n
// Title: slice-06: Orchestrate one agent plus verify pass
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190410-xwo3kz0n.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190410-xwo3kz0n"
  title: "slice-06: Orchestrate one agent plus verify pass"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Run produces a final Oya verdict, not an AI-decided success.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo-fix --prompt noop runs, then Run produces a final Oya verdict, not an AI-decided success.",
