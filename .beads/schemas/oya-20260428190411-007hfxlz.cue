...
// Validation schema for bead: oya-20260428190411-007hfxlz
// Title: slice-07: Create oya-contracts crate shell
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-007hfxlz.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-007hfxlz"
  title: "slice-07: Create oya-contracts crate shell"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Contracts crate builds for native target.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo check -p oya-contracts runs, then Contracts crate builds for native target.",
