...
// Validation schema for bead: oya-20260428190410-5ne59fsn
// Title: slice-06: Wire minimal run state machine
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190410-5ne59fsn.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190410-5ne59fsn"
  title: "slice-06: Wire minimal run state machine"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Valid transitions succeed and invalid transitions return typed errors.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test run_state_machine runs, then Valid transitions succeed and invalid transitions return typed errors.",
