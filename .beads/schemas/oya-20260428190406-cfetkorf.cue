...
// Validation schema for bead: oya-20260428190406-cfetkorf
// Title: slice-01: Doctor checks Fjall data dir
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-cfetkorf.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-cfetkorf"
  title: "slice-01: Doctor checks Fjall data dir"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Doctor reports Fjall readiness without mutating existing evidence.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya doctor runs, then Doctor reports Fjall readiness without mutating existing evidence.",
