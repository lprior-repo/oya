...
// Validation schema for bead: oya-20260428190410-nbto2qkt
// Title: slice-06: Add one real small bead demo
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190410-nbto2qkt.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190410-nbto2qkt"
  title: "slice-06: Add one real small bead demo"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "One small real bead reaches green verification or typed blocked state.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo-fix --prompt make-failing-test-pass runs, then One small real bead reaches green verification or typed blocked state.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:10Z"
//   }
// }