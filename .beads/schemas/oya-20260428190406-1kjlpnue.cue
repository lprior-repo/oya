...
// Validation schema for bead: oya-20260428190406-1kjlpnue
// Title: slice-01: Stabilize doctor JSONL output
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-1kjlpnue.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-1kjlpnue"
  title: "slice-01: Stabilize doctor JSONL output"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Doctor emits structured checks with names, status, category, and message.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya doctor runs, then Doctor emits structured checks with names, status, category, and message.",
