...
// Validation schema for bead: oya-20260428190406-spezny0h
// Title: slice-01: Doctor checks canonical Restate ports
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-spezny0h.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-spezny0h"
  title: "slice-01: Doctor checks canonical Restate ports"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Doctor reports canonical port readiness and unreachable states.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya doctor runs, then Doctor reports canonical port readiness and unreachable states.",
