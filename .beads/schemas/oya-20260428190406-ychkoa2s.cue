...
// Validation schema for bead: oya-20260428190406-ychkoa2s
// Title: slice-01: Lock green Moon CI baseline
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-ychkoa2s.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-ychkoa2s"
  title: "slice-01: Lock green Moon CI baseline"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "The CI slice completes with fmt, clippy, tests, holdout, build, and cue-check green.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when moon run :ci runs, then The CI slice completes with fmt, clippy, tests, holdout, build, and cue-check green.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:07Z"
//   }
// }