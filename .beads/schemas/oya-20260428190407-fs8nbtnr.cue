...
// Validation schema for bead: oya-20260428190407-fs8nbtnr
// Title: slice-02: Persist PromptRecord before agent call
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-fs8nbtnr.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-fs8nbtnr"
  title: "slice-02: Persist PromptRecord before agent call"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "PromptRecord exists before agent request evidence.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya run --bead-id demo --prompt noop runs, then PromptRecord exists before agent request evidence.",
