...
// Validation schema for bead: oya-20260428190411-zkrcyjm9
// Title: slice-07: Move lifecycle status DTOs
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-zkrcyjm9.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-zkrcyjm9"
  title: "slice-07: Move lifecycle status DTOs"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Core and frontend consume the same status DTOs.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test status_dto_roundtrip runs, then Core and frontend consume the same status DTOs.",
