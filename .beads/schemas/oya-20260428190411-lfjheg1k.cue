...
// Validation schema for bead: oya-20260428190411-lfjheg1k
// Title: slice-07: Add lifecycle status client
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-lfjheg1k.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-lfjheg1k"
  title: "slice-07: Add lifecycle status client"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Client parses lifecycle status and unavailable errors.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test lifecycle_status_client runs, then Client parses lifecycle status and unavailable errors.",
