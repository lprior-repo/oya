...
// Validation schema for bead: oya-20260428190407-mmwhlxh6
// Title: slice-02: Add evidence Fjall keyspace
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-mmwhlxh6.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-mmwhlxh6"
  title: "slice-02: Add evidence Fjall keyspace"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Evidence records are written and reloaded in order.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test evidence_fjall runs, then Evidence records are written and reloaded in order.",
