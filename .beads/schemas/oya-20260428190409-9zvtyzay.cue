...
// Validation schema for bead: oya-20260428190409-9zvtyzay
// Title: slice-04: Lock shared OpenCode error predicate
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-9zvtyzay.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-9zvtyzay"
  title: "slice-04: Lock shared OpenCode error predicate"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Known OpenCode error shapes are detected consistently.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test opencode_output_is_error runs, then Known OpenCode error shapes are detected consistently.",
