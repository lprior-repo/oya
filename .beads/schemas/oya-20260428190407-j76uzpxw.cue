...
// Validation schema for bead: oya-20260428190407-j76uzpxw
// Title: slice-02: Implement status by run id
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190407-j76uzpxw.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190407-j76uzpxw"
  title: "slice-02: Implement status by run id"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Status reports run phase and last evidence record.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya status --run-id demo-run runs, then Status reports run phase and last evidence record.",
