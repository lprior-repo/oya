...
// Validation schema for bead: oya-20260428190406-0o0v1twz
// Title: slice-00: Make agent prompts Git-only
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190406-0o0v1twz.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190406-0o0v1twz"
  title: "slice-00: Make agent prompts Git-only"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Generated agent prompt contains Moon/OpenCode/GitHub guidance and no non-Git VCS requirement.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test workflow_prompt runs, then Generated agent prompt contains Moon/OpenCode/GitHub guidance and no non-Git VCS requirement.",
