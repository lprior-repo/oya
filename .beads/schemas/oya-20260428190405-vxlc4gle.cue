...
// Validation schema for bead: oya-20260428190405-vxlc4gle
// Title: slice-00: Add Git-only proof check
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190405-vxlc4gle.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190405-vxlc4gle"
  title: "slice-00: Add Git-only proof check"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Active source/config checks report Git-only VCS assumptions.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test git_only_vcs runs, then Active source/config checks report Git-only VCS assumptions.",
...
//     beads_closed: false
//     timestamp: "2026-04-28T19:04:05Z"
//   }
// }