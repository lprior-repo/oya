...
// Validation schema for bead: oya-20260428190411-jzi5ig0f
// Title: slice-08: Block dirty Git worktree
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-jzi5ig0f.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-jzi5ig0f"
  title: "slice-08: Block dirty Git worktree"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Dirty worktree blocks with no agent call.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test git_dirty_block runs, then Dirty worktree blocks with no agent call.",
