...
// Validation schema for bead: oya-20260428190409-2kbb1y4f
// Title: slice-05: Persist RepairAttempt
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190409-2kbb1y4f.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190409-2kbb1y4f"
  title: "slice-05: Persist RepairAttempt"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "RepairAttempt is persisted before re-verification.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya verify --bead-id demo --repair runs, then RepairAttempt is persisted before re-verification.",
