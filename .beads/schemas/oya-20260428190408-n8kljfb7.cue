...
// Validation schema for bead: oya-20260428190408-n8kljfb7
// Title: slice-03: Run one Moon gate
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-n8kljfb7.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-n8kljfb7"
  title: "slice-03: Run one Moon gate"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Oya runs one Moon task and records status.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya verify --bead-id demo --gate fmt runs, then Oya runs one Moon task and records status.",
