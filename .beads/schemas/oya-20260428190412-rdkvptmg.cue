...
// Validation schema for bead: oya-20260428190412-rdkvptmg
// Title: slice-09: Block evidence tampering
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190412-rdkvptmg.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190412-rdkvptmg"
  title: "slice-09: Block evidence tampering"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Tampered evidence blocks with EvidenceIntegrityViolation.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya evidence check runs, then Tampered evidence blocks with EvidenceIntegrityViolation.",
