...
// Validation schema for bead: oya-20260428190412-awl8bh19
// Title: slice-08: Validate non-empty Git diff
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190412-awl8bh19.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190412-awl8bh19"
  title: "slice-08: Validate non-empty Git diff"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Empty diff blocks PR creation with evidence.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test diff_validation runs, then Empty diff blocks PR creation with evidence.",
