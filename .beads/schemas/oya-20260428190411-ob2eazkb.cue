...
// Validation schema for bead: oya-20260428190411-ob2eazkb
// Title: slice-07: Set frontend canonical ports
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190411-ob2eazkb.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190411-ob2eazkb"
  title: "slice-07: Set frontend canonical ports"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "Frontend defaults match Oya canonical ports.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when cargo test frontend_ports runs, then Frontend defaults match Oya canonical ports.",
