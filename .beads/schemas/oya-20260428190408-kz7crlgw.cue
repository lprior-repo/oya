...
// Validation schema for bead: oya-20260428190408-kz7crlgw
// Title: slice-03: Map Moon failures to typed categories
//
// This schema validates that implementation is complete.
// Use: cue vet oya-20260428190408-kz7crlgw.cue implementation.cue

#BeadImplementation: {
  bead_id: "oya-20260428190408-kz7crlgw"
  title: "slice-03: Map Moon failures to typed categories"
  ...
  contracts_verified: {
    ...
    postcondition_checks: [
      "A failing gate records a typed category, not Command.",
  ...
  tests_passing: {
    ...
    required_happy_tests: [
      "Given prerequisites are met, when oya verify --bead-id demo --gate fmt runs, then A failing gate records a typed category, not Command.",
