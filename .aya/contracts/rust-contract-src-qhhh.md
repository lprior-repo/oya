...
**Priority:** P1
**Size:** small
**Generated:** 2026-02-07 23:49:48
**Type:** Feature

## Overview

crates/oya-ui/src/layout.rs has 13 unwrap/expect violations.
- **Risk**: HIGH - UI rendering
- **Violations**: 13 instances
1. Replace unwrap/expect with proper error handling
2. Zero panic policy
3. Preserve 3-pane layout functionality
- Zero violations
...
See `martin-fowler-tests-src-qhhh.md` for comprehensive test strategy.
