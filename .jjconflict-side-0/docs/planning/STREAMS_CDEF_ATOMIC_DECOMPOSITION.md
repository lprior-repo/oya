...
## Stream E: Tauri Desktop UI + axum Backend (27 tasks)

### Bead: `intent-cli-20260201020059-ttfabixq` - axum REST API
**Atomic Tasks**: 5 tasks (4hr → 5x 1hr)

| Task ID | Title | Effort | Focus |
|---------|-------|--------|-------|
| task-048 | backend: Define axum router with REST API routes | 1hr | Router setup |
| task-049 | backend: Implement POST /api/workflows endpoint | 1hr | Create endpoint |
| task-050 | backend: Implement GET /api/beads/:id endpoint | 1hr | Query endpoint |
| task-051 | backend: Implement POST /api/beads/:id/cancel endpoint | 1hr | Cancel endpoint |
| task-052 | backend: Add tower middleware (CORS, tracing, compression) | 1hr | Middleware |

**Parallelization**: 048→(049, 050, 051 parallel)→052

---

### Bead: `intent-cli-20260201020059-hwlgqn0s` - WebSocket server
**Atomic Tasks**: 4 tasks (4hr → 1hr + 1hr + 2hr + 1hr)

| Task ID | Title | Effort | Focus |
|---------|-------|--------|-------|
| task-053 | backend: Define WebSocket connection handler | 1hr | WS upgrade |
| task-054 | backend: Implement bincode BeadEvent serialization | 1hr | Serialization |
| task-055 | backend: Implement event broadcasting to all WebSocket clients | 2hr | Broadcasting |
| task-056 | backend: Subscribe WebSocket server to BeadEvent stream | 1hr | Event subscription |

**Parallelization**: 053→054→055→056 sequential

---

### Bead: `intent-cli-20260201020059-o7uvwmxl` - Tauri + Leptos scaffold
**Atomic Tasks**: 4 tasks (4hr → 1hr + 2hr + 1hr + 1hr)

| Task ID | Title | Effort | Focus |
|---------|-------|--------|-------|
| task-057 | ui: Create Tauri 2.0 project scaffold | 1hr | Project structure |
| task-058 | ui: Initialize Leptos 0.7 CSR app structure | 2hr | Leptos setup |
| task-059 | ui: Implement HTTP client for REST API communication | 1hr | HTTP client |
| task-060 | ui: Establish WebSocket connection to backend | 1hr | WS connection |
...
|---------|-------|--------|--------------------------|
| task-061 | ui: Define DAGViz Leptos component structure | 1hr | src-1o6.15, 1o6.28 (Node/Edge structs) |
| task-062 | ui: Implement force-directed layout algorithm | 2hr | src-1o6.3, 1o6.5, 1o6.8, 1o6.10, 1o6.12, 1o6.16, 1o6.29 |
| task-063 | ui: Implement Canvas rendering with RequestAnimationFrame | 2hr | src-1o6.2, 1o6.4, 1o6.6, 1o6.7, 1o6.9, 1o6.11, 1o6.18, 1o6.22, 1o6.25, 1o6.30-33 |
| task-064 | ui: Implement pan/zoom controls with mouse events | 2hr | src-1o6.13, 1o6.17, 1o6.20, 1o6.21, 1o6.23, 1o6.24 |
| task-065 | ui: Implement node color mapping and hover states | 1hr | src-1o6.19, 1o6.26, 1o6.27 |
| task-066 | ui: Add comprehensive DAG viz component tests | 1hr | src-1o6.14, 1o6.16, 1o6.18, 1o6.24, 1o6.27 |
...
### Bead: `intent-cli-20260201020059-4eih0cdy` - WebSocket integration
**Atomic Tasks**: 3 tasks (2hr → 1hr + 1hr + 30min)

| Task ID | Title | Effort | Focus |
|---------|-------|--------|-------|
| task-067 | ui: Define WebSocket event handler in Leptos app | 1hr | Event handler |
| task-068 | ui: Implement reactive DAG state updates from events | 1hr | Reactive updates |
| task-069 | ui: Add WebSocket integration tests with mock events | 30min | Testing |
...
| Task ID | Title | Effort | Focus |
|---------|-------|--------|-------|
| task-070 | ui: Define Timeline Leptos component structure | 1hr | Component setup |
...
| task-073 | ui: Implement manual controls (cancel, retry, view logs) | 2hr | Control buttons |
| task-074 | ui: Add error visualization with conditional rendering | 1hr | Error display |
...
- Track E1: axum REST API (tasks 048-052)
- Track E2: WebSocket server (tasks 053-056)
- Track E3: Tauri + Leptos scaffold (tasks 057-060)
- Track E4: DAG visualization (tasks 061-066)
- Track E5: WebSocket integration (tasks 067-069)
