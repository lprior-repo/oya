...
/// let key2: IdempotencyKey = key_str.parse().expect("invalid UUID");
/// assert_eq!(key, key2);
/// ```
...
mod tests {
    ...
    fn test_from_str() {
        ...
        let key: IdempotencyKey = uuid_str.parse().expect("invalid UUID");
    ...
    fn test_from_str_roundtrip() {
        ...
        let parsed_key: IdempotencyKey = uuid_str.parse().expect("parse failed");
