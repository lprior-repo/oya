//! # DAG Layout with Memoized Spring Forces
//!
...
// Re-export UI layout components for spring force calculations
pub use oya_ui::layout::{
    spring_force::{SpringForce, Position, Force, SpringForceError},
    dag_edge::{calculate_line_path, PathSegment, EdgeError}
};
...
mod tests {
    ...
    fn test_cache_invalidation() {
        ...
        dag.add_node("b".to_string()).unwrap();
        layout.dag_mut().add_node("b".to_string()).unwrap();
